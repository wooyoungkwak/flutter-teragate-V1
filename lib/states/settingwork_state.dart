        ...
        body: ListView(children: <Widget>[
          Container(
            ...
            child: Row(
              ...
              children: [
                if (widget.getstate == 0) Text(initTimeGetIn[weekKR.length - 1], style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w300)) else if (widget.getstate == 1) Text(initTimeGetOut[weekKR.length - 1], style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
          ...
          IgnorePointer(ignoring: !switchDay[weekKR.length - 1], ignoringSemantics: false, child: Expanded(child: Container(color: Color.fromARGB(255, 241, 237, 237), height: 500.0, child: getListView()))),
        ]));
  }
    ...
    return ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
              ...
              child: setWeekFutureBuilder(index));
        });
  }
 
  FutureBuilder setWeekFutureBuilder(index) {
